# Contribuire a Bootstrap Regione Lombardia
...
L'[issue tracker](https://github.com/RegioneLombardia/bootstrap-lombardia/issues) è il posto giusto dove inserire segnalazioni di bug,
...
- Per favore, **non** usare l'issue tracker per richieste di supporto personali.
  Per queste è meglio scrivere a <a href="mailto:enzo.ferri@ariaspa.it">enzo.ferri@ariaspa.it</a> per un contatto diretto.
...
Le label sono utili per identificare le issue (criticità), tra le principali troviamo:
