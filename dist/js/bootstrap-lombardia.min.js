(function (global, factory) {
    ...
    function it25Header(){function e(){var e=document.getElementById("btn-hamburger").querySelector("svg").querySelector("use"),t=e.getAttribute("xlink:href").replace("it-burger","it-close-big");e.setAttribute("xlink:href",t),document.getElementById("btn-hamburger").setAttribute("aria-label","Chiudi menù");}function t(){var e=document.getElementById("btn-hamburger").querySelector("svg").querySelector("use"),t=e.getAttribute("xlink:href").replace("it-close-big","it-burger");e.setAttribute("xlink:href",t),document.getElementById("btn-hamburger").setAttribute("aria-label","Apri menù");}document.getElementById("it25-main-nav")&&(document.getElementById("it25-main-nav").addEventListener("show.bs.collapse",e),document.getElementById("it25-main-nav").addEventListener("hide.bs.collapse",t));}
