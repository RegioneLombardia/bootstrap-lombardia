...
{% capture callout %}
#### <svg class="icon icon-danger icon-lg"><use xlink:href="{{ site.baseurl }}/dist/svg/sprites.svg#it-close-circle"></use></svg> Deprecato: c'è un nuovo componente card
Bootstrap-italia ha reso disponibile una nuova versione del componente, che migliora l'accessibilità by design.  
Il componente qui documentato, **è ancora basato sulla vecchia versione.**  
La sua documentazione rimane *temporanemente* disponibile, ma **è deprecato e le sue classi di stile saranno rimosse** dalla prossima versione maggiore. 
