...
Sempre allo stesso *div* contenitore delle card/immagini possono essere applicate altre due classi, specifiche di *{{ site.data.short.bl }}*: `it25-carousel-nav` e `it25-carousel-autoplay`.  
