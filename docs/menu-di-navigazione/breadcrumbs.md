...
Per maggiorni informazioni, guarda le [{{ site.data.short.rl-guide }} WAI-ARIA per la creazione di breadcrumb](https://www.w3.org/TR/wai-aria-practices/#breadcrumb).
