## [2.7.3](https://github.com/RegioneLombardia/bootstrap-lombardia/compare/v2.7.2...v2.7.3) (2026-09-18)

### Features

* aggiornamento accordion ([2b8e0a0](https://github.com/RegioneLombardia/bootstrap-lombardia/commit/2b8e0a02cccee11db6a6978c3a4a025769fd57fd))
* aggiornamento list ([bc5ef1e](https://github.com/RegioneLombardia/bootstrap-lombardia/commit/bc5ef1eb60641b4c6a8f124cada0efb23f5979ef))
...
### Features
* Eliminate Linee Guida old


### BREAKING CHANGES

**Componenti eliminati**
I seguenti componenti personalizzati per Regione Lombardia, sono stati eliminati.  
Al loro posto si possono utilizzare componenti standard descritti nella documentazione tecnica.
* Calendario -> [Input Calendario](https://regionelombardia.github.io/bootstrap-lombardia/docs/form/input-calendario/)
* Divisori -> totalmente eliminato
* Dropdown menu -> [Dropdown](https://regionelombardia.github.io/bootstrap-lombardia/docs/componenti/dropdown/)
* Slider -> totalmente eliminato
* Snackbar -> [Notifiche](https://regionelombardia.github.io/bootstrap-lombardia/docs/componenti/notifiche/)
* Time picker -> [Input Ora](https://regionelombardia.github.io/bootstrap-lombardia/docs/form/input-ora/)
...
* nuova versione componente card ([ecc6588](https://github.com/RegioneLombardia/bootstrap-lombardia/commit/ecc6588d1ce7fff9181fb363ea5833ac09d7732f))
...
* bottone hamburger in menu verticale ([9445f5a](https://github.com/RegioneLombardia/bootstrap-lombardia/commit/9445f5aacde1754b30bbdf7c90e69ea8f0a11dad))

---
### Merge 2.16.1 -> 2.17.0 bootstrap-italia 
...
---
### Merge 2.15.0 -> 2.16.0 bootstrap-italia
...
---
### Merge 2.13.0 -> 2.14.0 bootstrap-italia
...
* allineamento alla 2.12.1 di bootstrap italia

---
### Merge 2.11.2 -> 2.12.1 bootstrap-italia
...
* allineamento alla 2.11.1 di bootstrap-italia


---
### Merge 2.9.2 -> 2.11.1 bootstrap-italia
...
---
### Merge 2.8.5 -> 2.9.1 bootstrap-italia
...
---
### Merge 2.8.3 -> 2.8.4 bootstrap-italia
...
---
### Merge 2.7.8 -> 2.8.2 bootstrap-italia
...
---
### Merge 2.3.6 -> 2.7.7 bootstrap-italia
...
* allineamento a 2.3.5 bootstrap-italia
